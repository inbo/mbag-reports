...
Bij het MAS gebeurt stratificatie van punten op basis van een engere definitie van landbouwgebied door een combinatie van regels (beschreven in Secties …).
...
Anderzijds kunnen punten van de ABV sneller worden geteld (zowel tijdsduur als afstand tussen punten) zodat dit meetnet nuttig is om meer algemene trends te detecteren op een goedkopere manier.
Wij stellen voor beide meetnetten 6 jaar parallel te laten verlopen zodat we tijdreeksen kunnen vergelijken.
