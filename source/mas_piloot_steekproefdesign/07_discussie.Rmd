...
De relatieve foutenmarge (halve breedte van het 95 % betrouwbaarheidsinterval gedeeld door de geschatte densiteit) op de jaarlijkse densiteitsschattingen in de Oostelijke leemstreek liggen voor Veldleeuwerik tussen `r round(min(rfm_stats))` % en `r round(max(rfm_stats))` %.
