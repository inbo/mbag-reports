...
5.  Binnen of buiten gebieden met soortenbeschermingsprogramma\
    We breiden soortenbeschermingsprogrammagebieden uit.
...
Het verzekeren van voldoende vrijwilligers bij vogelmonitoringsprojecten blijkt de laatste jaren niet evident.
Zo loopt het aantal vrijwilligers die deelnemen aan ABV gestaag terug, waardoor het beoogde aantal hokken niet gehaald wordt puur op vrijwillige basis.
Ook de inbreng van vrijwilligers in het veldwerk voor de nieuwe vogelatlas, daar bleven nog gaten oningevuld bij gebrek aan vrijwilligers.
Het spreekt voor zich dat we daarmee rekening moeten houden voor de verderzetting van MAS-tellingen met ervaren vrijwilligers, alsook voor de uitrol van een nieuw meetnet naar nieuwe regio’s.
Uit de ervaring opgedaan tijdens het piloot project bleek dat vrijwilligers via de tellingen een bijdrage willen leveren aan de bescherming van akkervogels, en daar voldoende \textcolor{red}{...} Ook bleek dat groepsgevoel, gezamenlijke activiteiten (regionaal) en communicatie van groot belang is.
Daarbij werd voorzien in het jaarlijks opfrissen van de methodiek, het bespreken van broedcodes, identificatie van soorten op zicht en op geluid, zowel als webinar als in het veld tijdens trainingsdagen.
Het lijkt ook een meerwaarde te zijn als de vrijwilligers jaarrond met het thema geactiveerd blijven, waarbij vrijwilligersorganisaties ook buiten het broedseizoen activiteiten en tellingen voorzien in het buitengebied.
Sprekende voorbeelden daarvan zijn het opzetten van slaapplaatstellingen van kiekendieven, seizoensbijeenkomsten met informatiedoorstroom van analyses, excursies rond het thema wintervoedsel.
Op die manier zijn we er in geslaagd om continuïteit te voorzien van vaste tellers, die jaarlijks opnieuw willen deelnemen, alsook een lichte groei aan nieuwe vrijwilligers die telpunten opnemen.
Bij een uitrol in nieuwe regio’s is het onrealistisch om meteen van het ene jaar op het andere jaar te verwachten dat een aanzienlijk aandeel telpunten meteen wordt opgenomen door lokale vrijwilligers.
Het garanderen dat alle punten van de steekproef geteld geraken, vooral in nieuwe en controlegebieden, is enkel mogelijk bij een aanzienlijk professionele ondersteuning van vrijwilligers (waarbij gewerkt kan worden aan communicatie, training en opvolging) alsook van betaalde krachten die telpunten tellen.
