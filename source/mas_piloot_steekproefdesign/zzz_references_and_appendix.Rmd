...
read_csv(file.path("media", "distance", "per_stratum",
  ...
  kable(digits = 5,
        caption = paste(
          "Resultaten van species change indices (SCI's) binnen",
          "t.o.v. buiten soortenbeschermingsprogramma per regio, jaar",
          "en openheidsklasse."
        ),
        booktabs = TRUE) %>%
  kableExtra::kable_styling(latex_options = c("scale_down", "striped")) %>%
...
```{r sbp-per-soort, out.width = "100%", fig.cap = "Gebruikte kaarten van soortenbeschermingsprogramma's in de leemstreek en de zandleemstreek."}
