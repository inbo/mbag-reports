...
Aangezien de MAS-uitbreiding naar Vlaanderen op macro-schaal gebeurt, verwachten we hier geen problemen.
...
Naast een minimum oppervlakte moet natuurlijk ook gewaarborgd worden dat het subgebied genoeg telpunten bevat, want deze zullen bepalen hoeveel data er per subgebied aanwezig is en bijgevolg de power van statistische analyses.
...
8.  Uitduinnen van steekproef\
    Om te veel overlap te voorkomen binnen eenzelfde stratum, is voor elk punt binnen hetzelfde stratum nagegaan of een punt met grotere `sample_order` op minder dan 600 m (Zandleemstreek) afstand ligt.
