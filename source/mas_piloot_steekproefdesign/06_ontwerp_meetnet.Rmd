...
Zie bijlage \@ref(bijlage-uitrol-mas), Figuur \@ref(fig:steekproef-afbakening-mbag) voor de visualisatie van de methodiek (cf. Fig. \@ref(fig:steekproef-afbakening) in sectie \@ref(piloot-ontwerp)).
