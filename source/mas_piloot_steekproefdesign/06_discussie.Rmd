...
De analyse van beschikbare data bracht enkele afwegingen en discussiepunten met zich mee.
Zo bleek de inschatting van de zichtbaarheid \textcolor{red}{...} Het verplaatsen van de meetpunt, waarbij de waarnemer zelf nog kan schuiven richting een plek met beter zicht, hebben we verboden.
Dit toelaten zou het random aspect van de steekproeftrekking te veel kunnen beïnvloeden.
Omdat een waarnemer niet exact op het puntcoördinaat zal plaatsnemen, met een nauwkeurigheid van een meter, hebben we daar wel wat flexibiliteit in aangebracht.
De telcirkel zelf blijft waar die ligt, maar de waarnemer mag zich wel binnen een zone van 25 m rondom het telpunt (bewegingsruimte) positioneren in functie van zo goed mogelijke zichtbaarheid in de telcirkel.
Deze wijziging hebben we op verschillende manieren gecommuniceerd, via de nieuwsbrief, webinars, op trainingsdagen en bij het overlopen van analyses.
Dit moet jaarlijks best herhaald worden.

Een ander aspect is het belang van afstanden om detectiecurves op te stellen, waarbij de afstand van de waarnemer ten opzichte van de vogel zo exact mogelijk moet gebeuren.
Wat we dus niet kunnen toelaten is het tellen vanaf andere plaatsen dan het eigenlijke telpunt, omdat vanop een afstand observeren ook de inschatting van, alsook het effect van het al dan niet aanwezig zijn in het centrum van de telcirkel.

Verschillen tussen vrijwilligers en professionelen waren significant, tijdens de beperkte vergelijkende studie.
We willen hier vooral geen kwaad bloed zetten, of het werk van professionals ophemelen.
Het toont vooral aan dat er blijvende aandacht nodig is voor opleiding, met herhaalde infosessies en oefeningen om de kwaliteit van de tellingen hoog te houden.
Daar waar vrijwilligers nog ervaring of vertrouwen missen, zou het goed zijn om een inloopperiode te voorzien, waarbij iemand mee kan gaan om tellingen uit te voeren samen met een ervaren teller.
...
Binnen dit pilootproject is al een eerste belangrijke stap gezet om deze modellen te fitten.
