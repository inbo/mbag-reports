...
De volgende variabelen hebben nul als derde kwartiel: `andere_hfdtlt`, `braakland_hfdtlt`, `andere_graangewassen_hfdtlt`, `houtachtige_gewassen`, `water_hfdtlt`, `zaden_hfdtlt`, `zomergranen_hfdtlt`.
...
```{r total-propsb, out.width = "90%", fig.cap = "Totale oppervlakte soortbeschermingsmaatregelen binnen de perimeters van het pilootproject over de jaren heen per regio opgedeeld per categorie."}
include_graphics(file.path("media", "data_exploratie",
