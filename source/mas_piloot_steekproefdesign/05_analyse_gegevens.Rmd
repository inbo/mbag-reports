...
include_graphics(file.path("media", "distance", "per_jaar", "oppervlakte_strata.jpg"))
```
...
Dit was puur om wille van tijdsoverwegingen, maar dit kan ook in éénzelfde analyse worden gedaan (zoals we in (1) doen).
...
include_graphics(file.path("media", "distance", "per_stratum", "oppervlakte_strata.jpg"))
```
