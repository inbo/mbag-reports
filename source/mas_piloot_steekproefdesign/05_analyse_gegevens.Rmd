...
Dit zien we bijvoorbeeld ook als we Kneu en Kievit vergelijken (Fig. \@ref(detectiekans-vergelijking)) waarbij deze laatste ook een soort is die meestal op grotere afstanden wordt gezien o.w.v. het gedrag van de soort.
...
```{r detectiekans-vergelijking, out.width = "90%", fig.cap = "Vergelijking van de fit van de detectiecurve op de data tussen Kneu en Kievit."}
include_graphics(file.path("media", "distance", "per_jaar",
