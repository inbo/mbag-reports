...
Een cumulatieve ranking proportie voor variabele $x$ van 90 % bij \<= $j=5$ will bijvoorbeeld zeggen dat $x$ in 90 % van de CV folds een ranking kleiner of gelijk aan 5 heeft.
