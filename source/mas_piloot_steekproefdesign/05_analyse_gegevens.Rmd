...
Tijdens het pilootproject \@ref(fig:relfreqs-2022-2023) zien we andere soorten naar voor komen en ook lagere frequenties.
...
```{r relfreqs-zoogdieren, out.width = "100%", fig.cap = "..."}
include_graphics(file.path("media", "data_exploratie",
...
We gebruikten hiervoor dus opnieuw de kaartklaag van landbouwgebruikspercelen.

```{r perceelsgrootte-methode, out.width = "90%", fig.cap = "Voor de berekeningen m.b.t. perceelsgroottes, selecteerden we overlappende percelen. In tegenstelling tot berekeningen gerelateerd aan oppervlakte-aandelen nemen we dus geen strikte intersectie. Hier een voorbeeld van de percelen gerelateerd aan telpunten DM\\_386.7 en DM\\_44.45."}
...
```{r vervalfunctie, out.width = "90%", fig.cap = "Voorbeeld van een logistische en exponentiele vervalfunctie over 3 km."}
include_graphics(file.path("media", "verklarende_variabelen",
                           "distance_decay.pdf"))
```
...
pa_veldleeuwerik <- round(
  (n1_veldleeuwerik + n2_veldleeuwerik)/(nc1_veldleeuwerik + nc2_veldleeuwerik),
  digits = 3)
```
