...
```{r dubbeltellingen-aantallen, out.width = "90%", fig.cap = "Verschil in aantal soorten en waarnemingen van vogels met broedcode groter dan nul tussen vrijwilligers en professionele teller met aanduiding van posterior gemiddelde en 95  \\% credible interval."}
