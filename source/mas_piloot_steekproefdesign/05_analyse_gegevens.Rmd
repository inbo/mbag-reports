...
De tellingen zijn hoger in de Leemstreek maar daar waren ook meer telpunten.
...
Voor elke soort kunnen we de relatieve frequentie ($P$) berekenen als de proportie telpunten waarin de soort aanwezig is per telperiode $t$, jaar $j$ en regio $r$.

$$
P_{t,j,r} = \sum_{i=1}^{N_{t,j,r}} I(n_i > 0) / N_{t,j,r}
$$

Waarbij $N_{t,j,r}$ het totaal aantal telpunten is in telperiode $t$, jaar $j$ en regio $r$ en $n_i$ het aantal individuen van de beschouwde soort waargenomen van telpunt $i$.
