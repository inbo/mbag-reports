...
```{r telintensiteit, out.width = "90%", fig.cap = "..."}
include_graphics(file.path("media", "data_exploratie",
                           "tellingen_mas_2018_2023.jpg"))
```

```{r aantal-waarnemingen, out.width = "100%", fig.cap = "..."}
include_graphics(file.path("media", "data_exploratie",
                           "waarnemingen_mas_2018_2023.jpg"))
```

```{r aantal-soorten, out.width = "100%", fig.cap = "..."}
include_graphics(file.path("media", "data_exploratie",
                           "soorten_mas_2018_2023.jpg"))
```

### Broedcodes

```{r broedcodes, out.width = "100%", fig.cap = "..."}
include_graphics(file.path("media", "data_exploratie",
                           "broedcode_mas_2022_2023.jpg"))
```

### Relatieve frequenties

```{r relfreqs, out.width = "90%", fig.cap = "..."}
include_graphics(file.path("media", "data_exploratie",
                           "soortenfreqs_mas_2018_2023.jpg"))
```

```{r verschilfreqs, out.width = "90%", fig.cap = "..."}
include_graphics(file.path("media", "data_exploratie",
                           "verschilfreq_total_mas_2018_2023.jpg"))
```
...
## Vergelijking van gepaarde tellingen tussen vrijwillige en professionele tellers
...
We zien dat vrijwilligers een significant minder aantal waarnemingen en soorten melden dan de professionele teller (Fig. \@ref(fig:dubbeltellingen-aantallen)).
...
We hebben dus zeker geen bewijs dat er compensatie zou zijn bij de vrijwilligers waarbij ze wel meer soorten zouden zouden noteren met broedcode 0, maar minder met broedcode \> 0.
Voor aantal waarnemingen konden we hetzelfde besluiten (95 % CI: -0.2 tot 0.24).

```{r dubbeltellingen-aantallen, out.width = "90%", fig.cap = "..."}
include_graphics(file.path("media", "dubbeltellingen",
                           "vergelijk_aantallen.jpg"))
```
...
```{r dubbeltellingen-correlatie, out.width = "90%", fig.cap = "..."}
include_graphics(file.path("media", "dubbeltellingen",
                           "correlatie_aantallen.jpg"))
```
...
include_graphics(file.path("media", "distance", "per_stratum",
                           "densiteit_per_stratum_methods_veldleeuwerik.jpg"))
```
