...
Bovendien kunnen aantallen van eenzelfde plot meer op elkaar lijken dan aantallen dan aantallen van verschillende plots.
...
De professionele teller is ervaren, maar bij de vrijwilligers hebben we twee ervaringscategoriën: "beginner" ($X_{ervaring} = 0$) en "ervaren" ($X_{ervaring} = 1$).
